  ...
  return (
    <footer className={`${showFilter ? "hide-div" : null}`}>
      <div className="about">
        ...
        <a href="https://github.com/Ansonsd5" target="_blank"><i class="fa fa-github"></i></a>
        <a href="https://twitter.com/Anson__Dsouza" target="_blank"><i class="fa fa-twitter"></i></a>
        <a href="https://www.linkedin.com/in/ansonsd" target="_blank"><i class="fa fa-linkedin"></i></a>
        </div>
      </div>
      ...
      <div className="contact">
        ...
        <div className="sub-heading e-mail">
          <i className="fa fa-envelope"></i>support@webstore.com
        </div>
      </div>
    </footer>
  );
